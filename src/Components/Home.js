...
import { getCurrentUser, loginOutUser, addData } from '../lib/librariesfirebase.js';
...
export const Home = () => {
  ...
  <main class="main">
    ...
    <input class="post__input" id="post" type="text" placeholder="Cuéntanos lo que estás pensando . . ."></input>
